...
# 2026-01-28
# These are a council-defined construct grouping the electoral wards into 9 groups.
# They are aligned to the new ward boundaries which came into effect from May 2023.  This is the third revision, moving Hale Barns & Timperley South into into the Altrincham, Bowdon and Hale cluster.
...
group_wards_into_creative_clusters <- function(ward_geometry, resolution_name) {
    ...
    ward_geometry %>%
        ...
        mutate(area_name = case_when(
            area_name %in% c("Ashton upon Mersey", "Broadheath", "Brooklands", "Manor", "Sale Central", "Sale Moor") ~ "Ashton upon Mersey, Broadheath, Brooklands, Manor, Sale Central and Sale Moor cluster",
            ...
            area_name %in% c("Altrincham", "Bowdon", "Hale", "Hale Barns & Timperley South") ~ "Altrincham, Bowdon, Hale and Hale Barns & Timperley South cluster",
