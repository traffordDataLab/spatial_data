...
# They are aligned to the new ward boundaries which came into effect from May 2023.  This is the second revision, moving Broadheath into the Sale Central cluster and Hale into the Altrincham and Bowdon cluster.
...
group_wards_into_creative_clusters <- function(ward_geometry, resolution_name) {
    ...
    ward_geometry %>%
        ...
        mutate(area_name = case_when(
            ...
            area_name %in% c("Altrincham", "Bowdon", "Hale") ~ "Altrincham, Bowdon and Hale cluster",
