## ONS Postcode Directory (August 2023) ##

# Source: ONS Open Geography Portal
# Publisher URL: https://geoportal.statistics.gov.uk/datasets/ons-postcode-directory-august-2023/about
...
pcode_file_reference <- "ONSPD_AUG_2023_UK" # makes it easier to change this once here than throughout the code below

# https://geoportal.statistics.gov.uk/datasets/ons-postcode-directory-august-2023/about
tmp <- tempfile(fileext = ".zip")
GET(url = "https://www.arcgis.com/sharing/rest/content/items/487a5ba62c8b4da08f01eb3c08e304f6/data",
    write_disk(tmp))
