...
<h1>Postcodes</h1>
*Postcode list for Trafford by ward, MSOA and locality with centroids.*
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><a href="https://geoportal.statistics.gov.uk/datasets/ons-postcode-directory-february-2021" target="_blank">Office for National Statistics (ONS)</a></td>
    ...
    <td><time datetime="2021-03-09">2021-03-09</time></td>
  </tr>
</table>
