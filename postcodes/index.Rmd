...
<h1>Postcodes</h1>
*Postcodes (active and terminated) for Trafford and Greater Manchester (GM) by LA, Ward, MSOA, LSOA and OA with centroids. Trafford file also contains localities.*
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    <td><a href="https://geoportal.statistics.gov.uk/datasets/ons::ons-postcode-directory-may-2026/about" target="_blank">ONS Open Geography Portal</a></td>
    ...
    <td>Contains OS data &copy; Crown copyright and database right 2026. Contains Royal Mail data &copy; Royal Mail copyright and database right 2026. ONS postcode products (derived from Code-Point&reg; Open) are subject to the Open Government Licence.</td>
    <td><time datetime="2026-08-14">2026-08-14</time></td>
  </tr>
</table>
...
```
<div id="tableFooterTitle">Active and terminated Postcodes in Trafford</div>
