...
<h1>Postcodes</h1>
*Postcode list for Trafford and Greater Manchester by LA, Ward, MSOA and LSOA with centroids. Trafford file also contains localities.*
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    <td><a href="https://geoportal.statistics.gov.uk/datasets/ons-postcode-directory-november-2023/about" target="_blank">ONS Open Geography Portal</a></td>
    <td><a href="https://www.ons.gov.uk/" target="_blank">Office for National Statistics (ONS)</a></td>
    <td><time datetime="2023-11-29">2023-11-29</time></td>
    <td>Point data</td>
    <td><a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a></td>
    <td>ONS postcode products (derived from Code-Point&reg; Open) are subject to the Open Government Licence.</td>
    <td><time datetime="2023-11-30">2023-11-30</time></td>
  </tr>
</table>
